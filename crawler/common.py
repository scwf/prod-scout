...
def organize_single_post(post, source_name):
    ...
    4. 各列说明：
       ...
       - **分类**: 给该事件打一个标签（如：技术发布、产品动态、观点分享、商业资讯、技术活动（meetup/会议/沙龙）、客户案例、广告招聘、其他）
