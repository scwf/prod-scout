...
class XScraper:
    ...
    def __init__(
        ...
        user_switch_delay: Tuple[float, float] = (10.0, 30.0),
    ...
    def from_config(cls, config: configparser.ConfigParser) -> 'XScraper':
        ...
        return cls(
            ...
            request_delay=(
                config.getfloat('x_scraper', 'request_delay_min', fallback=3.0),
                config.getfloat('x_scraper', 'request_delay_max', fallback=8.0),
            ),
            user_switch_delay=(
                config.getfloat('x_scraper', 'user_switch_delay_min', fallback=10.0),
                config.getfloat('x_scraper', 'user_switch_delay_max', fallback=30.0),
            ),
